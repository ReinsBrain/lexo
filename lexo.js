...
lexo.LFIncrement = function ( strLexo, maxlen, boolNoPad, boolHigherOrder ) {
	...
	if (lastcharidx == -1) throw new Error('The supplied value for strLexo parameter includes invalid characters.');
	var strLexoi;
	...
	if (lastcharidx == (charlist.length -1)) {
		...
		var newlastchar = charlist.charAt(lastcharidx + 1);
		strLexoi = strLexo.substring(0,strLexo.length-1) + newlastchar;
	}
